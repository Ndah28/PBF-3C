  ...
  return (
    <Router>
      <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
        <Link className="navbar-brand" to="/about">Masterpiece.Sang</Link>
      ...
      <div>
        ...
        <footer class="page-footer font-small blue">
          <div class="footer-copyright text-center py-3">© 2020 Copyright : Masterpiece.Sang</div>
        </footer>
      </div>
    </Router>
  );
...
function AboutPage() {
  return (
    <h3>Instagram : @Masterpiece.Sang</h3>
  );
}
